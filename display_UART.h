...
#define COOLING_SP_MIN_F		0x0001
#define COOLING_SP_MAX			1
#define COOLING_SP_MAX_F		0x0002
#define COOLING_SP				2
#define COOLING_SP_F			0x0004
#define COOLING_DIF_1			3
#define COOLING_DIF_1_F			0x0008
#define HIGH_TEMP_ALARM_SP		4
#define HIGH_TEMP_ALARM_SP_F	0x0010
#define HIGH_TEMP_ALARM_DIF		5
#define HIGH_TEMP_ALARM_DIF_F	0x0020
#define LOW_TEMP_ALARM_SP		6
#define LOW_TEMP_ALARM_SP_F		0x0040
#define LOW_TEMP_ALARM_DIF		7
#define LOW_TEMP_ALARM_DIF_F	0x0080
#define FROST_ALARM_SP			8
#define FROST_ALARM_SP_F		0x0100
#define FROST_ALARM_DIF			9
#define FROST_ALARM_DIF_F		0x0200
#define HEATING_SP_MIN			10
#define HEATING_SP_MIN_F		0x0400
#define HEATING_SP_MAX			11
#define HEATING_SP_MAX_F		0x0800
#define HEATING_SP				12
#define HEATING_SP_F			0x1000
#define HEATING_DIF				13
#define HEATING_DIF_F			0x2000
#define COMP_MIN_STOP_TIME		14
#define COMP_MIN_STOP_TIME_F	0x4000
#define RW_REG_END				15
...
#define DISP_RX_BUF_LEN			26							// Creates a RX buffer of given length
...
extern uint16_union modbus_rw_reg_rcv[RW_REG_LEN];			// read/write registers, modbus 1-15
extern uint16_union modbus_rw_reg_snd[RW_REG_LEN];			// read/write registers, modbus 1-15
extern uint16_union modbus_ro_reg_rcv[RO_REG_LEN];			// read only registers, modbus 201-220
extern uint16_union modbus_ero_reg_rcv[ERO_REG_LEN+1];		// extended read only registers, modbus 501-504 599
extern uint16_union modbus_ero_reg_snd[ERO_REG_LEN+1];		// extended read only registers, modbus 501-504 599
